...
export const requireRequestAuthContext = (
  request: DashboardAuthedRequest,
...
export const actorDiscordUserId = (auth: DashboardAuthContext | undefined): string | undefined =>
  auth?.kind === 'discord' ? auth.discordUserId : undefined;
