...
import { autoReportModes, compareAccessModes, compareModes, gameFamilies } from './constants.js';
...
type SettingsTabProps = {
  ...
  onSaveConfig: (event: SyntheticEvent<HTMLFormElement>) => void;
  ...
  <form className="config-grid" onSubmit={onSaveConfig}>
    ...
    <label className="checkbox-row">
      <input
        ...
        onChange={(event) => updateConfigField('comparePublicPostingEnabled', event.target.checked)}
      />
