      ...
      'no-restricted-imports': [
        'error',
        {
          paths: [
            ...
            {
              name: '@wcl/discord',
              message: 'shared/domain must not depend on Discord transport concerns.',
            },
            {
              name: '@wcl/wcl-client',
              message: 'shared/domain must not depend on Warcraft Logs transport clients.',
            },
            {
              name: '@wcl/web',
              message: 'shared/domain must not depend on web app-layer concerns.',
            },
            {
              name: '@wcl/worker',
              message: 'shared/domain must not depend on worker app-layer orchestration.',
            },
          ],
        },
      ],
