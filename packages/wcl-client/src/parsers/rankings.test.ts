      ...
      data: [
        {
          ...
          roles: {
            tanks: {
              characters: [{ id: 10, name: 'Tanky', rankPercent: 98.2, amount: 123456 }],
            },
            healers: {
              characters: [{ id: 11, name: 'Healz', rankPercent: 90.1, amount: 654321 }],
            },
            dps: {
              characters: [{ id: 12, name: 'Dpsy', rankPercent: 88.4, amount: 111111 }],
            },
          },
        },
      ],
