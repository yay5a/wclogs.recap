...
export class WclReportFetchError extends Error {
  ...
  public constructor(input: {
    ...
    super(
      input.message ?? `WCL report fetch failed (${input.category})`,
...
const categoryForAuthStatus = (authMode: WclAuthModeKind): WclReportFetchFailureCategory =>
...
export const shouldRetryWithUserLinkedAuth = (error: WclReportFetchError): boolean =>
